...
<div style="display: flex; align-items: center;">
  <div style="flex: 1;">
    ...
    I believe causality will play an essential role in the cost and time efficient development of AI systems that have prediction, control and counterfactual reasoning capabitilies that can generalize to unseen contexts. I aim to close the gap between theory and practice to enable machine learning systems to truly understand our causal world.
  </div>
